...
class BilligerPriceChecker:
    ...
    def _init_driver(self):
        ...
        # When running from PyInstaller bundle, explicitly set Chrome binary location
        # and detect Chrome version
        chrome_version = None
                ...
                for chrome_path in chrome_paths:
                    if os.path.exists(chrome_path):
                        ...
                        try:
                            ...
                            # Extract major version (e.g., "Google Chrome 144.0.7559.133" -> 144)
                            match = re.search(r"Chrome (\d+)\.", version_output)
                            if match:
                    ...
                    logger.error("Chrome not found in standard locations. Please install Google Chrome.")
                    raise FileNotFoundError(
                        "Google Chrome not found. Please install it from:\n"
